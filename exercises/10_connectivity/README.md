...
* backend type "Non SAP System" -> Protocol "HTTP" -> Internal host "localhost", Internal port "10080" -> Virtual Host & port 는 필요할경우 변경 -> Principal propagation type "None" -> Finish;
